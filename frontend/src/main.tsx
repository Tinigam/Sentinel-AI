...
type AskAnswer = { answer: string; insufficient_evidence: boolean; summary_points: { claim: string; citation_ids: string[] }[]; sources: { id: string; title: string; source: string; published_at: string | null; url: string; snippet: string }[]; retrieval: { method: string; candidate_count: number; source_count: number }; generator: string };
